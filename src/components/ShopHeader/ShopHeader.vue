<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowDetails = true">
    ...
    <div
      ...
      v-if="info.supports"
      @click="isShowDiscounts = true"
    >
      <div class="discounts-left">
        <div class="activity " :class="activeColor[info.supports[0].type]">
          <span class="content-tag">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShowDetails">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowDetails = false">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
        <div class="brief-modal-cover" @click="isShowDetails = false"></div>
      </div>
    </transition>
      ...
      <div class="activity-sheet" v-show="isShowDiscounts">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li
              class="activity-item"
              :class="activeColor[support.type]"
